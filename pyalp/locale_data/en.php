...
$lang = array(
    ...
    "admin_prize_control" => array(
		...
		"note_lock" => " Locking the prizes is an irreversible action. Before you lock prizes, make sure that you've <a href=\"admin_prizes.php\" border=\"0\">entered all of the prizes</a> that are to be drawn for or won in tournaments. <b>Once prizes are locked, no more prizes can be added, and users cannot change the prizes they've registered for</b>",
