...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('techsupport_techsupport', (
            ...
            ('fixer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fixer', null=True, to=orm['auth.User'])),
            ('info', self.gf('django.db.models.fields.TextField')()),
            ('result', self.gf('django.db.models.fields.TextField')()),
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assigned_to', null=True, to=orm['auth.User'])),
        ))
    ...
    models = {
        ...
        'techsupport.techsupport': {
            ...
            'fixer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fixer'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
