...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GameRequest'
        db.create_table('tournaments_gamerequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tournaments.Game'])),
            ('gamename', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('itemtime', self.gf('django.db.models.fields.DateTimeField')()),
            ('ipaddress', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('queryport', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('tournaments', ['GameRequest'])


    def backwards(self, orm):
        # Deleting model 'GameRequest'
        db.delete_table('tournaments_gamerequest')
