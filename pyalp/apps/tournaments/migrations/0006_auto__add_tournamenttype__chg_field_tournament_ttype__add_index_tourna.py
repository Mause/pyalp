...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TournamentType'
        db.create_table('tournaments_tournamenttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tournament_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('time', self.gf('django.db.models.fields.IntegerField')()),
            ('minimum_teams', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('tournaments', ['TournamentType'])


        # Renaming column for 'Tournament.ttype' to match new field type.
        db.rename_column('tournaments_tournament', 'ttype', 'ttype_id')
        # Changing field 'Tournament.ttype'
        db.alter_column('tournaments_tournament', 'ttype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tournaments.TournamentType']))
        # Adding index on 'Tournament', fields ['ttype']
        db.create_index('tournaments_tournament', ['ttype_id'])


    def backwards(self, orm):
        # Removing index on 'Tournament', fields ['ttype']
        db.delete_index('tournaments_tournament', ['ttype_id'])

        # Deleting model 'TournamentType'
        db.delete_table('tournaments_tournamenttype')


        # Renaming column for 'Tournament.ttype' to match new field type.
        db.rename_column('tournaments_tournament', 'ttype_id', 'ttype')
        # Changing field 'Tournament.ttype'
        db.alter_column('tournaments_tournament', 'ttype', self.gf('django.db.models.fields.IntegerField')())
