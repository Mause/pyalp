...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Server.ipaddress'
        db.alter_column('tournaments_server', 'ipaddress', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Server.ipaddress'
        db.alter_column('tournaments_server', 'ipaddress', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))
