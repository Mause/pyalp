...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamType.game'
        db.add_column('tournaments_teamtype', 'game',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tournaments.Game'], default=0),
                      keep_default=False)

        # Adding field 'TeamType.onename'
        db.add_column('tournaments_teamtype', 'onename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'TeamType.onecolor'
        db.add_column('tournaments_teamtype', 'onecolor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'TeamType.twoname'
        db.add_column('tournaments_teamtype', 'twoname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'TeamType.twocolor'
        db.add_column('tournaments_teamtype', 'twocolor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamType.game'
        db.delete_column('tournaments_teamtype', 'game_id')

        # Deleting field 'TeamType.onename'
        db.delete_column('tournaments_teamtype', 'onename')

        # Deleting field 'TeamType.onecolor'
        db.delete_column('tournaments_teamtype', 'onecolor')

        # Deleting field 'TeamType.twoname'
        db.delete_column('tournaments_teamtype', 'twoname')

        # Deleting field 'TeamType.twocolor'
        db.delete_column('tournaments_teamtype', 'twocolor')
