...
$colors['background'] = '#FCF7F3';
$colors['primary'] = '#5A88D8'; //FFFF00 
$colors['secondary'] = '#CCCC00';//129AC4
$colors['border'] = '#396693';//
$colors['border_alternate'] = '#181821'; // currently only used on bargraph borders
$colors['cell_title'] = '#AAAAAA';//344E78
$colors['cell_background'] = '#ffffff';//273A5A 
$colors['cell_alternate'] = '#777777';//282832
$colors['text'] = '#333';//B0B0BF
$colors['blended_text'] = '#000000';//838498
