...
$x->add_selectlist(
    ...
    1,
    0,
    get_lang('desc_pizzaid')." (<a href=\"pizza_list.php\">".get_lang('link_pizza_list')."</a>)",
    array("empty" => get_lang('error_pizzaid')),
    "SELECT pizzaid,pizza FROM pizza WHERE enabled='1'",
    "pizzaid",
    "pizza",
    1
);
$x->add_text(
    ...
    1,
    0,
    get_lang('desc_quantity'),
    array("empty" => get_lang('error_quantity')),
    10
);
$x->add_selectlist(
    "userid",
    ...
    1,
    0,
    get_lang('desc_userid'),
    array(),
    "SELECT userid,
    username FROM users WHERE userid='".$_COOKIE["userid"]."'",
    "userid",
    "username",
    0
);
