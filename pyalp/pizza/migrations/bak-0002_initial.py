...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pizza_pizza', (
            ...
            ('price', self.gf('djmoney.models.fields.MoneyField')(max_digits=20, decimal_places=2, default_currency='XYZ')),
    ...
    models = {
        ...
        'pizza.pizza': {
            ...
            'price': ('djmoney.models.fields.MoneyField', [], {'max_digits': '20', 'decimal_places': '2', 'default_currency': "'XYZ'"}),
